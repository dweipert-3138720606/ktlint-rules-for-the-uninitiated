...
class BlankLineBeforeReturnRuleTest {
    private val assertThat = KtLintAssertThat.assertThatRuleBuilder { BlankLineBeforeReturnRule() }
        .withEditorConfigOverride(
            RuleId("uninitiated:blank-line-before-return").createRuleExecutionEditorConfigProperty(RuleExecution.enabled) to RuleExecution.enabled,
        )
        .assertThat()
