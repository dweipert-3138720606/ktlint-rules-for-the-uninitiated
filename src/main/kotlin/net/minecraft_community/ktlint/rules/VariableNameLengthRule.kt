...
val MIN_VARIABLE_NAME_LENGTH_PROPERTY: EditorConfigProperty<Int> = run {
    ...
    EditorConfigProperty(
        ...
        propertyMapper = { property, _ ->
            if (property == null || property.isUnset) {
                ...
                if (parsed.isValid) parsed.parsed else default
            }
        },
...
val SKIP_VARIABLE_NAMES_PROPERTY: EditorConfigProperty<String> = run {
    val type = PropertyType(
    ...
    EditorConfigProperty(
        ...
        androidStudioCodeStyleDefaultValue = default,
        propertyMapper = { property, _ ->
            if (property == null || property.isUnset) default else property.sourceValue
        },
        propertyWriter = { it },
...
class VariableNameLengthRule : Rule(
    ...
    override fun beforeFirstNode(editorConfig: EditorConfig) {
        ...
        skipNames = editorConfig.get(SKIP_VARIABLE_NAMES_PROPERTY)
            .split(",")
            .map { it.trim() }
